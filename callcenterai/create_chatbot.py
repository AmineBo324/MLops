...
<head>
    ...
    <title>CallCenterAI - Assistant IA</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <script>
        const SERVICE_URL = 'http://localhost:8003/route_agent';
        let isTyping = false;
        ...
        async function sendMessage() {
            ...
            try {
                ...
                hideTyping();
                addErrorMessage('Désolé, je ne peux pas vous répondre pour le moment. Veuillez réessayer.');
        ...
        function addBotResponse(result) {
            ...
            const textDiv = document.createElement('div');
            textDiv.className = 'message-text';
            textDiv.textContent = getBotMessage(result.category);
            ...
            categoryBadge.innerHTML = `${getCategoryIcon(result.category)} ${formatCategory(result.category)}`;
            
            const confidence = document.createElement('span');
            confidence.className = 'confidence';
            confidence.textContent = `${(result.confidence * 100).toFixed(1)}% confiance`;
        ...
        window.onload = function() {
            ...
            console.log('🤖 CallCenterAI Chatbot chargé! v3.0');
            console.log('💡 Service Agent IA: http://localhost:8003/route_agent');
        };
    </script>
</body>
</html>
